...
namespace Unravel
{
    ...
    public abstract class Application : HttpApplication
    {
        ...
        ///       see <see cref="AspNetCore.Http.HttpContextAccessor"/> for details
        ///     </item>
        ///   </list>
        /// </summary>
        ...
        protected IWebHost BuildWebHost(IAppBuilder app)
        {
            return CreateWebHostBuilder()
                .ConfigureServices(services =>
                {
                    ...
                    services.AddSingleton<Microsoft.AspNetCore.Http.IHttpContextAccessor, AspNetCore.Http.HttpContextAccessor>();
                })
                .Build();
        }
